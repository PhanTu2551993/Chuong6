namespace _6._2
{
        ...
        public class LineSegment : Shape
        {
            ...
            {
                Console.WriteLine($"Drawing LineSegment from {Start} to {End}");
            }
        ...
        public class Circle : Shape
        {
            ...
            public override void Draw()
            {
                Console.WriteLine($"Drawing Circle with Center: {Center} and Radius: {Radius}");
            }
        ...
        public class Square : Rectangle
        {
            ...
            public override void Draw()
            {
                Console.WriteLine($"Drawing Square with Side Length: {Width}");
            }
        ...
        public class Triangle : Shape
        {
            ...
            public override void Draw()
            {
                Console.WriteLine($"Drawing Triangle with Vertices: {Vertex1}, {Vertex2}, {Vertex3}");
            }
        ...
        public class Parallelogram : Shape
        {
            ...
            public override void Draw()
            {
                Console.WriteLine($"Drawing Parallelogram with Vertices: {Vertex1}, {Vertex2}, {Vertex3}, {Vertex4}");
            }
        ...
        public class Rhombus : Shape
        {
            ...
            public override void Draw()
            {
                Console.WriteLine($"Drawing Rhombus with Vertices: {Vertex1}, {Vertex2}, {Vertex3}, {Vertex4}");
            }
